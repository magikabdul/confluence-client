...
public class SpacePropertyValue extends AbstractOpenApiSchema {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            return (TypeAdapter<T>) new TypeAdapter<SpacePropertyValue>() {
                ...
                public SpacePropertyValue read(JsonReader in) throws IOException {
                    ...
                    throw new IOException(String.format("Failed deserialization for SpacePropertyValue: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public SpacePropertyValue(Boolean o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public SpacePropertyValue(List<String> o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public SpacePropertyValue(Map<String, Object> o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public SpacePropertyValue(String o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for SpacePropertyValue with oneOf schemas: Boolean, List<String>, Map<String, Object>, String. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
    }
  }
