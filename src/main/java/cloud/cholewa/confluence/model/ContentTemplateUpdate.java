...
import cloud.cholewa.confluence.model.ContentTemplateUpdateSpace;
...
public class ContentTemplateUpdate {
  ...
  **/
  ...
  public ContentTemplateUpdate space(ContentTemplateUpdateSpace space) {
    this.space = space;
    return this;
  }
  ...
  **/
  ...
  public void setSpace(ContentTemplateUpdateSpace space) {
    this.space = space;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ContentTemplateUpdate.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ContentTemplateUpdate is not found in the empty JSON string", ContentTemplateUpdate.openapiRequiredFields.toString()));
        }
      }
