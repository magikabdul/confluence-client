...
public class SpacePermissionRequest {
  ...
  **/
  ...
  public SpacePermissionRequest links(Map<String, GenericLinksValue> links) {
    this.links = links;
    return this;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SpacePermissionRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SpacePermissionRequest is not found in the empty JSON string", SpacePermissionRequest.openapiRequiredFields.toString()));
        }
      }
